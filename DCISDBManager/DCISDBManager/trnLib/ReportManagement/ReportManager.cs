...
namespace DCISDBManager.trnLib.ReportManagement
{
    public class ReportManager
    {
        ...
        public DataTable getCORegistry_MonthlySummary(DateTime FDate, DateTime TDate, string CertRateID, string InvoSupDID, string InvoRID, string OthrDRID, string CID, string NCEM, string PayType)
        {
            try
            {
                connection.Open();
                ...
                cmd.CommandText = "DCISgetCORegistryMnthSummry";
