...
/*
PROGRAM-ID.       MassActiveCertificateTemplate.cs
...
{
    public class MassActiveCertificateTemplate
    {
       ...
       // string Comment = string.Empty;
        ...
        public MassActiveCertificateTemplate(CertificateRequestHeader CRH, List<CertificateRequestDetail> CRDlist, string LOGOpath, string DocPath, string AuthOffer,string Date)
        {
        ...
        public MassActiveCertificateTemplate(string CertificateID, CertificateRequestHeader CRH, List<CertificateRequestDetail> CRDlist, string LOGOpath, string DocPath, string AuthOffer, string Telephone)
        {
            this.LOGOimgPath = LOGOpath;
            this.CertificateHead = CRH;
            this.CertReqDetails = CRDlist;
