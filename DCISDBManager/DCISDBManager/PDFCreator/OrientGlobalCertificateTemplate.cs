...
{
    public class OrientGlobalCertificateTemplate
    {
       ...
       // string Comment = string.Empty;
        ...
        public OrientGlobalCertificateTemplate(CertificateRequestHeader CRH, List<CertificateRequestDetail> CRDlist, string LOGOpath, string DocPath, string AuthOffer,string Date)
        {
        ...
        public OrientGlobalCertificateTemplate(string CertificateID, CertificateRequestHeader CRH, List<CertificateRequestDetail> CRDlist, string LOGOpath, string DocPath, string AuthOffer, string Telephone)
        {
            this.LOGOimgPath = LOGOpath;
            this.CertificateHead = CRH;
            this.CertReqDetails = CRDlist;
        ...
        private bool drawCertificateOfOrginHeader()
        {
            try
            {
                ...
                PdfPCell InoviceNoNDateCell1 = new PdfPCell(new Phrase("5. Invoice Date : " + this.CertificateHead.InvoiceDate1.ToString("dd/MM/yyyy"), fontItemDetails));
                ...
                PdfPCell PlaceofDeliveryCellData = new PdfPCell(new Phrase(this.CertificateHead.PortOfDischarge1, fontBoxDetailFontSmal)); //this.CertificateHead.PortOfDischarge1
        ...
        private void printlistRow()
        {
            ...
            //if (CertReqDetails.Count < 8)
            //{
            //    for (int i = 0; i < 8 - CertReqDetails.Count; i++)
            //    {
        ...
        private void drwRectangle()
        {
            ...
            PdfPCell GoodItemHead = new PdfPCell(new Phrase(this.CertificateHead.OtherDetails1, fontBoxDetail));//Rectangle
